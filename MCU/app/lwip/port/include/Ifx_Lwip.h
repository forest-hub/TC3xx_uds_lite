...
#define IFXGETH_MAX_TX_BUFFER_SIZE (1024+IFXGETH_HEADER_LENGTH+2) // bytes
#define IFXGETH_MAX_RX_BUFFER_SIZE (1024+IFXGETH_HEADER_LENGTH+2) // bytes
...
/** \addtogroup lib_lwIP
 * \{ */
IFX_EXTERN void     Ifx_Lwip_init(void);
